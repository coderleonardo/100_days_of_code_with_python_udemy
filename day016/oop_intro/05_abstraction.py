...
class Novel(Book):
    ...
    def __repr__(self):
        return f"Book: {self.title}, Pages: {self.pages}, Quantity: {self.quantity}, Author: {self.author}, Price: {self.get_price()}"
...
# that inherit from the superclass must have their own implementation
# of the method.
